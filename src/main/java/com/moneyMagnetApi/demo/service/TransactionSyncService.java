...
public class TransactionSyncService {
    ...
    TransactionNature resolveNature(
        ...
        if (StringUtils.hasText(dto.nature())) {
            ...
            try {
                TransactionNature receivedNature = TransactionNature.valueOf(normalizedNature);
                if (receivedNature != TransactionNature.CREDIT_CARD_PAYMENT
                        || account.getType() == com.moneyMagnetApi.demo.domain.account.AccountType.CREDIT) {
        ...
        if ("05100000".equals(dto.categoryId()) && account.getType() == AccountType.CREDIT) {
