...
public class TransactionController {
        ...
        @GetMapping
        @Operation(summary = "Lista transacoes do usuario", description = "Retorna transacoes paginadas, com filtro opcional por periodo.", responses = {
        ...
        @Operation(summary = "Atualiza dados editaveis de uma transacao", description = "Permite alterar descricao e/ou categoria de uma transacao.", responses = {
        ...
        public ResponseEntity<TransactionResponse> update(
                        ...
                        @Parameter(description = "Nova descricao da transacao") @RequestParam(required = false) String description,
                        @Parameter(description = "ID da nova categoria") @RequestParam(required = false) UUID categoryId) {
